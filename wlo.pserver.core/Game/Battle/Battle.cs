...
( (flag:gb)  50.1 s (player x, y, enermy x, y, ushort skill, timer 0 )
    ...
    public class Battle
    {
        ...
        //    {
        //        Side[(byte)BattleRole.Defending].Send_Attack(ppl_involved, moveData.Data.ToArray());
        //        Side[(byte)BattleRole.Attacking].Send_Attack(ppl_involved, moveData.Data.ToArray());
        //        Side[(byte)BattleRole.Watching].Send_Attack(ppl_involved, moveData.Data.ToArray());
        //    }
        //    RoundState = eBattleRoundState.EndedState;
        ...
        List<Fighter> AttackableTargets(List<byte[]> kl, BattleRole loc)
        {
            ...
            if (tmp.Count == 0)
                switch (loc)
                {
                    ...
                    //    {
                    //        foreach (Fighter u in Side[(byte)BattleRole.Attacking].Fighters_Alive)
                    //        {
                    //            tmp.Add(u); break;
                    //        }
                    //    } break;
                    ...
                    //    {
                    //        foreach (Fighter u in Side[(byte)BattleRole.Defending].Fighters_Alive)
                    //        {
                    //            tmp.Add(u); break;
                    //        }
                    //    } break;
    ...
    //    Battle battleRef;
    //    int pos; int turn;
    //    public BattleRole Position { get { return (BattleRole)pos; } }
    ...
    //                            }
    //                            foreach (Fighter lt in battleRef[BattleRole.Defending].fighterlist)
    ...
    //                                Send51_1(ft, 26, (ushort)ft.CurSP, (f as Player));
    //                            }
    //                            foreach (Fighter lt in battleRef[BattleRole.Attacking].fighterlist)
    //                                Send51_1(lt, 25, (ushort)lt.CurHP, (f as Player));
    //                        } break;
    //                }
    //                SendPacket p = new SendPacket();
    ...
    //            }
    //        }
    //        else if (fighter.TypeofFighter == eFighterType.Npc_Mob)
    //        {
    //            fighter.GridX = Placement[0];
    //            fighter.GridY = Placement[1];
    //        }
